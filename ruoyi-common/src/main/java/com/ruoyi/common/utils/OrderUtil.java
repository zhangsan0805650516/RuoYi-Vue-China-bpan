...
public class OrderUtil {
    ...
    public static void main(String[] args) {
        System.out.println("RE" + orderSn());
        System.out.println("RE" + OrderUtil.orderSn() + OrderUtil.randomNumber(0,9));
        System.out.println("RE" + OrderUtil.orderSn() + OrderUtil.randomNumber(0,9).intValue());
    }
