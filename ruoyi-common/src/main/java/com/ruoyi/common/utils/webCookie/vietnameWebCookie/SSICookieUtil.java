package com.ruoyi.common.utils.webCookie.vietnameWebCookie;
...
public class SSICookieUtil {

    private static final Logger log = LoggerFactory.getLogger(SSICookieUtil.class);
    
    /**
     * 获取NSE网站cookie
     * @return
     */
    public static String getSSICookie() {
        String cookie = "";

        HttpGet get = new HttpGet("https://iboard.ssi.com.vn/");
